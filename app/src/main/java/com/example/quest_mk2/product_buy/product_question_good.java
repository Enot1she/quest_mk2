...
public class product_question_good extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (bt_g.isChecked()){
                    array.getAns(true, 1);
                    Intent intentProduct_Result_g = new Intent(product_question_good.this, product_Result.class);
                    startActivity(intentProduct_Result_g);
                    ...
                    Toast.makeText(product_question_good.this, "Выберите вариант", Toast.LENGTH_LONG).show();
                }
            }
        });
